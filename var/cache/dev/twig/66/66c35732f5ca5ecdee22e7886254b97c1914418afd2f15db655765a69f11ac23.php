...
class __TwigTemplate_430d4e8d8032000a261d1f735f2f81f039368cd6aa4a378207eb6ed3bb655e1b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"d-flex flex-column my-5\" style=\"max-width: 350px\">
        ...
        echo "\" class=\"btn btn-secondary mt-3\">Afficher tous les produits</a>
        <a href=\"";
        // line 30
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_create");
        echo "\" class=\"btn btn-secondary mt-3\">Créer un produit</a>
    </div>
";
    ...
    {
        return array (  148 => 30,  144 => 29,  140 => 28,  136 => 27,  132 => 26,  128 => 25,  124 => 24,  120 => 23,  115 => 20,  105 => 16,  100 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"d-flex flex-column my-5\" style=\"max-width: 350px\">
        ...
        <a href=\"{{ path('product_index') }}\" class=\"btn btn-secondary mt-3\">Afficher tous les produits</a>
        <a href=\"{{ path('product_create') }}\" class=\"btn btn-secondary mt-3\">Créer un produit</a>
    </div>
{% endblock %}
